...
import 'package:articulate/ui/home/tile_screen.dart';
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          const snackBar =
                              SnackBar(content: Text('Press down to access!'));
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            const snackBar = SnackBar(
                                content: Text('Current language is English'));
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const HomeScreenMs()),
                            );
                          },
                          child: Text(
                            'BM',
                        ...
                        return Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: ColoredBox(
                              ...
                              child: ListTile(
                                key: Key('$categories'),
                                title: Text('${thisCategory['title-en']}',
